...
class TicState(TippyState):
    ...
    def __init__(self, p, interactive=False, board = [[' ',' ',' '],[' ',' ',' '],\
        ...
        self.instructions = ('The classic game of Tic-Tac-Toe.\nTo win, you must get a vertical, horiztonal, or diagonal line.')
...
def is_line(board):
    ...
    called is_tippy for the sake of simplicity (otherwise we would have to re-write
